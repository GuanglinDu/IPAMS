class VlansController < ApplicationController
  ...
  def index
    ...
    @vlans = Vlan.order(:vlan_number).paginate(page: params[:page],
  ...
  # 1. Importing from CSV in Rails:
  # http://kyle.conarro.com/importing-from-csv-in-rails
  # 2. Rails: Use controller for import:
  ...
  # only allow the white list through.lan_id is the FK.
  def vlan_params
